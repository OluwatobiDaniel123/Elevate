                    ...
                    <div className="mb-12 flex flex-wrap gap-2" role="tablist" aria-label="Event filters">
                        {eventFilters.map((item) => (
                            <button
                                ...
                                className={`px-4 py-3 text-[10px] font-bold uppercase tracking-[.16em] transition ${
                                    filter === item
                                        ? "bg-[#d8b982] text-black"
                                        : "border border-white/15 text-white/60 hover:border-[#d8b982]"
                                }`}
                            >
                                {item}
                            </button>
                    ...
                    {shown.length === 0 ? (
                        <div className="border border-white/10 p-12 text-center">
                            ...
                            <p className="mt-3 text-sm text-white/45">
                                Check back soon for the next Elevate experience.
                            </p>
                        </div>
                    ) : (
