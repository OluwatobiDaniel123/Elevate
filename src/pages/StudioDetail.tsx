...
export default function StudioDetail({podcast = false}: {podcast?: boolean}) {
    ...
    const studio = slug
        ...
        : studios.find((s) => (podcast ? s.slug === "podcast" : s.slug === "music"));
        ...
        <>
                ...
                title={
                    podcast ? (
                        <>
                            Your voice
                            <br />
                            <i>deserves a stage.</i>
                        </>
                    ) : (
                        <>
                            Turn your sound into
                            <br />
                            <i>something unforgettable.</i>
                        </>
                    )
                }
            ...
            <section className="bg-[#111110] px-5 py-24 lg:px-10">
                <div className="mx-auto grid max-w-[1100px] gap-14 md:grid-cols-[.75fr_1.25fr]">
                    <div>
                        <SectionTitle eyebrow="Book the studio" title={<></>} />
                        <p className="text-sm leading-7 text-white/50">
                            Tell us about your project and preferred dates. We’ll come back with availability and next
                            steps.
                        </p>
                        {/* <div className="mt-6">
                    ...
                    {/* <EnquiryForm
                        ...
                        fields={[
                            ...
                            },
                            {
                                ...
                                required: true,
                                options: podcast
                                    ? ["Podcast recording", "Video podcast", "Interview", "Content creation", "Other"]
                                    : [
                                          "Recording",
                                          "Music production",
                                          "Vocal recording",
