  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={<>Your event.<br /><i>Elevated.</i></>}
      ...
      <section className="px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-[1100px] gap-14 md:grid-cols-[.75fr_1.25fr]">
          <div>
            <SectionTitle eyebrow="Plan your event" title={<>Make it<br /><i>memorable.</i></>} />
            <p className="text-sm leading-7 text-white/50">Tell us about your event and we’ll come back with tailored options, availability and pricing.</p>
            <div className="mt-8 grid gap-4 text-sm text-white/60">
              <div className="border-t border-[#c8a870] pt-3">
                <p className="text-[10px] font-bold uppercase tracking-[.18em] text-[#d8b982]">Corporate</p>
              ...
              <div className="border-t border-[#c8a870] pt-3">
                <p className="text-[10px] font-bold uppercase tracking-[.18em] text-[#d8b982]">Brand activations</p>
          ...
          <EnquiryForm
            ...
            fields={[
              ...
              { name: 'event_type', label: 'Event type', type: 'select', required: true, options: ['Corporate party', 'Team celebration', 'Networking event', 'Brand activation', 'Product launch', 'Private party', 'Birthday', 'Christmas party', 'Other'] },
              { name: 'guests', label: 'Number of guests', type: 'number', required: true, halfWidth: true, min: 1, max: 500 },
              { name: 'preferred_date', label: 'Preferred date', type: 'date', halfWidth: true, minDate: true },
              { name: 'experience', label: 'Preferred experience', type: 'select', options: ['Full venue hire', 'Semi-private area', 'VIP section', 'Not sure yet'] },
              { name: 'budget', label: 'Budget range', type: 'select', options: ['Under £1,000', '£1,000 — £3,000', '£3,000 — £5,000', '£5,000 — £10,000', '£10,000+', 'Prefer to discuss'] },
