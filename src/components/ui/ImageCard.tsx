    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
                ...
                <span className="mt-6 inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[.18em] text-[#d8b982]">
                    Explore <ArrowDownRight size={15} className="-rotate-90" />
                </span>
            </div>
        </Link>
    );
